...
Pencil papermate = new Pencil();
Ruler thing = new Ruler();
Textbook school = new Textbook();
papermate.write("Hi");
thing.measure();
school.read();
pack.putInBackpack(papermate);
pack.putInBackpack(thing);
pack.putInBackpack(school);
pack.goToSchool();

...
showNextImage();
String leo = JOptionPane.showInputDialog("who is this?");

if (leo.equalsIgnoreCase("leonardo dicaprio")) {
	JOptionPane.showMessageDialog(null, "Right");
...
if (morgan.equalsIgnoreCase("morgan freeman")) {
	JOptionPane.showMessageDialog(null, "Right");
...
if (jack.equalsIgnoreCase("Jake Black")) {
	JOptionPane.showMessageDialog(null, "Right");
	JOptionPane.showMessageDialog(null, score + 3);
}else{
	JOptionPane.showMessageDialog(null, "This is Jake Black");
}
			// 6. Otherwise:
